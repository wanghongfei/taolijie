...
CREATE TABLE IF NOT EXISTS `taolijie`.`member` (
  ...
  `last_token_date` DATE NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `taolijie`.`banner_pic` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `picture_path` VARCHAR(45) NULL COMMENT '',
  `time` DATE NULL COMMENT '',
  `picture_id` INT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `taolijie`.`resume_post_rel` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `resume_id` INT NOT NULL COMMENT '',
  `job_post_id` INT NOT NULL COMMENT '',
  `created_time` DATE NULL COMMENT '投递时间',
  `member_id` INT NOT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `fk_resume_post_rel_resume1_idx` (`resume_id` ASC)  COMMENT '',
  INDEX `fk_resume_post_rel_job_post1_idx` (`job_post_id` ASC)  COMMENT '',
  INDEX `fk_resume_post_rel_member1_idx` (`member_id` ASC)  COMMENT '',
