...
public class ResumeModel extends Pageable {
     ...
     */
    @JsonIgnore
    private String intendIds;
    /**
     * 仅内部使用
     */
    @JsonIgnore
    private List<Integer> intendIdList;
    ...
    public String getIntendIds() {
        return intendIds;
    }

    public void setIntendIds(String intendIds) {
        this.intendIds = intendIds;
    }

    public List<Integer> getIntendIdList() {
        return intendIdList;
    }

    public void setIntendIdList(List<Integer> intendIdList) {
        this.intendIdList = intendIdList;
    }
