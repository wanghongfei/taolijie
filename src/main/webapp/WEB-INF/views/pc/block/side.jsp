...
<div class="side">
    <div class="services">
        ...
        <ul class="menu_left" id="menu_left">
            <li>
                <i class="fa fa-history fa-lg"></i> <a href="/list/job">学生兼职</a>
                <ul class="submenu">
            ...
            <li>
                <i class="fa fa-bicycle fa-lg"></i> <a href="/list/sh">校园二手</a>
                <ul class="submenu">
            ...
            <li>
               <i class="fa fa-paper-plane-o fa-lg"></i>  <a href="/list/resume">求职简历</a>
                <ul class="submenu">
            ...
            <li>
                <i class="fa fa-check-square-o fa-lg"></i> <a href="/user/job/post">发布信息</a>
                <ul class="submenu">
