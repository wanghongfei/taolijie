...
<div class="left-side sticky-left-side">
  ...
  <div class="left-side-inner">
    ...
    <!--sidebar nav start-->
    <ul class="nav nav-pills nav-stacked custom-nav">
      <li><a href="/manage/index"><i class="fa fa-laptop"></i> <span>控制台</span></a></li>
      <li class="menu-list "><a href=""><i class="fa fa-bookmark"></i> <span>查看帖子</span></a>
        <ul class="sub-menu-list">
          <li ><a href="/manage/jobs"> 兼职</a></li>
          <li><a href="/manage/shs"> 二手</a></li>
          <li><a href="/manage/resumes"> 简历</a></li>
        </ul>
      </li>

      <li class="menu-list"><a href=""><i class="fa fa-user"></i> <span>用户管理</span></a>
        <ul class="sub-menu-list">
          <li ><a href="/manage/adduser"> 添加用户</a></li>
          <li><a href="/manage/users"> 管理用户</a></li>

        </ul>
      </li>
      <li class="menu-list"><a href=""><i class="fa fa-tasks"></i> <span>校园聚焦点</span></a>
        <ul class="sub-menu-list">
          <li ><a href="/manage/addnews"> 添加新闻</a></li>
      ...
      <li class="menu-list"><a href=""><i class="fa fa-bullhorn"></i> <span>公告管理</span></a>
        <ul class="sub-menu-list">
          <li ><a href="/manage/addannounce"> 新增公告</a></li>
          <li><a href="/manage/announces"> 所有公告</a></li>

        </ul>
      </li>
      <li class="menu-list "><a href=""><i class="fa fa-envelope  "></i> <span>发送通知</span></a>
        <ul class="sub-menu-list">
          <li ><a href="/manage/addnotification"> 新增通知</a></li>
          <li><a href="/manage/notifications"> 所有通知</a></li>
        </ul>
      </li>
      ...
      <li class="menu-list"><a href=""><i class="fa fa-bullhorn"></i> <span>分类管理</span></a>
        <ul class="sub-menu-list">
          <li><a href="/manage/jobcategory"><i class="fa fa-folder-open-o"></i> <span>兼职分类</span></a>
          <li><a href="/manage/shcategory"><i class="fa fa-folder-open-o"></i> <span>二手分类</span></a>
        </ul>
      </li>
